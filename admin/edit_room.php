...
$rf_query = "SELECT facility_id, quantity, condition_status FROM room_facilities WHERE room_id = ?";
$rf_stmt = $conn->prepare($rf_query);
$rf_stmt->bind_param("i", $room_id);
$rf_stmt->execute();
$rf_result = $rf_stmt->get_result();
$room_facilities = [];
while ($rf = $rf_result->fetch_assoc()) {
    $room_facilities[$rf['facility_id']] = $rf;
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2>Edit Room: <?php echo htmlspecialchars($room['room_name']); ?></h2>
            ...
            <form action="../actions/update_room_process.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="room_id" value="<?php echo $room_id; ?>">
                <input type="hidden" name="current_image" value="<?php echo $room['image_url']; ?>">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                ...
                                <select id="room_type" name="room_type" class="form-control" required>
                                    <option value="tutorial_room" <?php echo $room['room_type'] === 'tutorial_room' ? 'selected' : ''; ?>>Tutorial Room</option>
                                    <option value="lecture_hall" <?php echo $room['room_type'] === 'lecture_hall' ? 'selected' : ''; ?>>Lecture Hall</option>
                                    <option value="lab" <?php echo $room['room_type'] === 'lab' ? 'selected' : ''; ?>>Computer Lab</option>
                                    <option value="meeting_room" <?php echo $room['room_type'] === 'meeting_room' ? 'selected' : ''; ?>>Meeting Room</option>
                                    <option value="seminar_room" <?php echo $room['room_type'] === 'seminar_room' ? 'selected' : ''; ?>>Seminar Room</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="capacity" name="capacity" class="form-control" 
                                       value="<?php echo $room['capacity']; ?>" required min="1">
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                ...
                                <input type="text" id="building" name="building" class="form-control" 
                                       value="<?php echo htmlspecialchars($room['building']); ?>" required>
                            </div>
                                ...
                                <div class="facility-type-group">
                                    ...
                                    <div class="facility-list">
                                        <?php foreach ($type_facilities as $facility): 
                                            $is_assigned = isset($room_facilities[$facility['facility_id']]);
                                            $qty = $is_assigned ? $room_facilities[$facility['facility_id']]['quantity'] : 1;
                                            $condition = $is_assigned ? $room_facilities[$facility['facility_id']]['condition_status'] : 'good';
                                        ?>
                                        <div class="facility-item <?php echo $is_assigned ? 'selected' : ''; ?>" id="facility-item-<?php echo $facility['facility_id']; ?>">
                                            ...
                                            <div class="facility-item-options" id="facility-options-<?php echo $facility['facility_id']; ?>" style="<?php echo $is_assigned ? 'display:flex' : 'display:none'; ?>">
                                                <div class="facility-option">
                                                    <label>Qty</label>
                                                    <input type="number" name="facility_qty[<?php echo $facility['facility_id']; ?>]" 
                                                           value="<?php echo $qty; ?>" min="1" max="999" class="form-control facility-input-sm">
                                                </div>
                                                <div class="facility-option">
                                                    ...
                                                    <select name="facility_condition[<?php echo $facility['facility_id']; ?>]" class="form-control facility-input-sm">
                                                        ...
                                                        <option value="broken" <?php echo $condition === 'broken' ? 'selected' : ''; ?>>Broken</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <div class="current-image">
                                <img src="../<?php echo $room['image_url']; ?>" class="image-preview" alt="Current Room Image">
