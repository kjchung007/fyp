...
<head>
    ...
    <title><?php echo htmlspecialchars($room['room_name']); ?> - FCSIT Room Booking</title>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="display: flex; justify-content: flex-end; margin-bottom: 20px;">
                <a href="browse_rooms.php" class="btn btn-outline"><i data-lucide="arrow-left" style="width:14px;height:14px;"></i> Back to Browse</a>
            </div>
            ...
            <div class="room-details">
                ...
                <div class="stats-grid" style="margin: 20px 0;">
                    ...
                    <div class="stat-card">
                        <div class="stat-card-inner">
                            ...
                            <div class="stat-icon green"><i data-lucide="map-pin" style="width:22px;height:22px;"></i></div>
                        </div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-card-inner">
                            ...
                            <div class="stat-icon <?php echo $room['status'] === 'available' ? 'green' : 'red'; ?>">
                                <i data-lucide="<?php echo $room['status'] === 'available' ? 'check-circle' : 'x-circle'; ?>" style="width:22px;height:22px;"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-label"><i data-lucide="settings" style="width:14px;height:14px;"></i> Available Facilities</div>
                ...
                <div class="section-label" style="margin-top:24px;"><i data-lucide="calendar" style="width:14px;height:14px;"></i> Upcoming Bookings</div>
                        ...
                        <div class="card-row-left">
                            ...
                            <div class="card-row-info">
                                ...
                                <div class="card-row-meta">
                                    ...
                                    <span><i data-lucide="user" style="width:12px;height:12px;"></i> <?php echo htmlspecialchars($booking['name']); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div style="margin-top: 28px; text-align: center;">
                    ...
                    <a href="book_room.php?id=<?php echo $room_id; ?>" class="btn btn-success" style="padding: 12px 32px;">
                        <i data-lucide="calendar-plus" style="width:16px;height:16px;"></i> Book This Room
                    </a>
                    <?php else: ?>
                    <div class="info-box warning" style="display:inline-block;">
